...
import { ReceiveNewsContainer, ReceiveNewsSubtitle, ReceiveNewsTitle } from './ReceiveNews.styles';
...
export default function ReceiveNews() {
  return (
    <ReceiveNewsContainer>
      ...
      <ReceiveNewsSubtitle>Cadastre-se e seja um dos primeiros a saber de todas as novidades e ofertas.</ReceiveNewsSubtitle>
